...
* link:#batch["batch"]
* link:annotations_ref#CHDCCIDA["@BatchFetch"]
...
* link:persistenceproperties_ref#CACBICGG2["jdbc.exclusive-connection.mode"]
...
See link:persistenceproperties_ref#CDEJGBEI["flush-clear.cache"] for
more information.
...
* link:persistenceproperties_ref#BABDHEEB["persistence-context.flush-mode"]
* link:persistenceproperties_ref#CDEJGBEI["flush-clear.cache"]
* "EclipseLink" JPA Query Hints
`http://wiki.eclipse.org/EclipseLink/UserGuide/JPA/Basic_JPA_Development/Querying/Query_Hints`
* "EclipseLink Caches" in _Understanding EclipseLink_
* "Querying" in _Solutions Guide for EclispeLink_
...
(see
link:persistenceproperties_ref#CCHIEAIA["descriptor.customizer"]).
...
* link:persistenceproperties_ref#CHDHAFAA["jdbc.cache-statements"]
* link:persistenceproperties_ref#CIHJADHF["jdbc.batch-writing.size"]
...
* link:persistenceproperties_ref#target-server["target-server"]
...
* link:annotations_ref#BABJBDEG["@FetchGroup"]
...
* link:annotations_ref#CHDBBIHE["@Cache"]
* "Caching
