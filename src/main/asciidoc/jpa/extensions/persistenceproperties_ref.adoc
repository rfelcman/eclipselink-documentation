...
[cols="^,^,",]
|=======================================================================
|link:queryhints.htm[image:../../../dcommon/images/larrow.png[Previous,width=16,height=16]]
|link:schema.htm[image:../../../dcommon/images/rarrow.png[Next,width=16,height=16]]
| 
|=======================================================================
...
image:img/override_tl.gif[Description of Figure 5-1
follows,title="Description of Figure 5-1 follows"] +
link:img_text/override_tl.htm[Description of "Figure 5-1 Using the
eclipselink.sessions-xml Persistence Property"] +
 +
