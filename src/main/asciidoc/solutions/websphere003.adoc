...
[cols="^,^,",]
|===
|link:websphere002.htm[image:../../dcommon/images/larrow.png[Previous,width=16,height=16]]
|link:migrnativetoplink.htm[image:../../dcommon/images/rarrow.png[Next,width=16,height=16]]
| 
|===
